...
export default function Contact({ whatsapp, phone, email }: ContactProps) {
  return (
    <section className="contact">
      ...
      <a className="contact__link" href={`tel:${phone}`} target="_blank" rel="noopener noreferrer" title="Contato pelo WhatsApp">
        <i className={`contact__icon fas fa-phone-alt`}></i>
        <span className="contact__name">Phone</span>
      </a>
      <a className="contact__link" href={`mailto:${email}`} target="_blank" rel="noopener noreferrer" title="Contato pelo WhatsApp">
